...
public class ChatService : IChatService
{
    ...
    public async Task<List<ChatThreadResponse>> GetShopChatsAsync(int shopId)
    {
        ...
        var result = new List<ChatThreadResponse>();
        foreach (var chat in chats)
        {
            ...
            result.Add(new ChatThreadResponse
            {
                ChatId = chat.ChatId,
                UserId = chat.UserId,
    ...
    public async Task<List<MessageResponse>> GetChatMessagesAsync(int shopId, int chatId, int pageIndex, int pageSize, int shopUserId)
    {
